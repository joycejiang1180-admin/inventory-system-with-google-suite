...
Originally prototyped in Google Sheets, now evolving into a full application.

## 📖 Development Journal
This project is documented through an honest development journal capturing:
- Daily progress and setbacks
- Design decisions and pivots
- Personal reflections on the building process
- Work-life balance challenges as a solo developer
